/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="comment-widget-pink/comment-widget.js"></script>
...
const s_stylePath = 'comment-widget-pink/comment-widget-pink.css';

const s_formId = '1FAIpQLSdS8Ako0GDkFKH4-J_Par4m6pu04c-EaaYY4Is-Xw4-I_Meqg';
const s_nameId = '1891091163';
const s_websiteId = '2082549917';
const s_textId = '662955512';
const s_pageId = '132137108';
const s_replyId = '690038281';
const s_sheetId = '1K4KAhoDpFxqm2W-TJXReqLvdSBY88DqBadruxUCrjnY';
